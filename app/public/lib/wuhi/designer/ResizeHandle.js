dojo.provide("wuhi.designer.ResizeHandle");

dojo.require("dijit._Widget");

dojo.declare("wuhi.designer.ResizeHandle", dijit._Widget, {
    targetNode: null,
    _handleNodes: [],
    ...
    createResizeHandles: function() {
        ...
        dojo.forEach(positions, function(item) {
            ...
            if (node = dojo.query("." + "wuhiDesignerResizeSquare_" + item.direction, this.targetNode)[0]) {
                ...
                dojo.addClass(node, "wuhiDesignerResizeSquare_" + item.direction);
