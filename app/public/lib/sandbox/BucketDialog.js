dojo.provide("sandbox.BucketDialog");
dojo.require("dijit.Dialog");
dojo.require("dijit.layout.ContentPane");
dojo.require("dijit.layout.TabContainer");
dojo.require("dojox.widget.Standby");

dojo.declare("sandbox.BucketDialog", dijit.Dialog, {
	...
	buildRendering: function() {
		...
		this._containerCP = new dijit.layout.ContentPane();
		...
		if (this.showSource === true) {
			...
			// html pane
			this._htmlPane = new dijit.layout.ContentPane({
				title: 'HTML'
			});
			this._tc.addChild(this._htmlPane);

			// js pane
			this._jsPane = new dijit.layout.ContentPane({
				title: 'Javascript'
			});
			this._tc.addChild(this._jsPane);

			// css pane
			this._cssPane = new dijit.layout.ContentPane({
				title: 'CSS'
			});
			this._tc.addChild(this._cssPane);
			
			// run pane
			this._ifrcp = new dijit.layout.ContentPane({
				title: 'Run'
			});
			this._tc.addChild(this._ifrcp);
		}

		this._sb = new dojox.widget.Standby( {
	...
	onShow: function() {
		...
		if (!this._iframe) {
			var ifr = dojo.doc.createElement('iframe');
